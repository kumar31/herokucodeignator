...
class get_client_card_details extends REST_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model('get_client_card_details_model');
	...
	public function index_post()
	{
		$validationandresult = new validationandresult();
			if(isset($_POST) != "")
			{
					...
					// Empty key checking.
					$pre_key = array('client_id','card_id');
					...
					else
					{
						...
						{ 
							...
							$result = $this->get_client_card_details_model->index();	
