...
class clone_event extends REST_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model('clone_event_model');
	...
	public function index_post()
	{
		$validationandresult = new validationandresult();
			if(isset($_POST) != "")
			{
					...
					// Empty key checking.
					$pre_key = array('event_id','client_id','event_name');
					...
					else
					{
						...
						{ 
							...
							$result = $this->clone_event_model->index();	
