...
class create_event_type extends REST_Controller {
		...
		$validationandresult = new validationandresult();
			if(isset($_POST) != "")
			{
					...
					else
					{
						...
						$this->form_validation->set_rules('name', 'name', 'trim|required|is_unique[event_type.name]');
						...
						{ 
							...
							$result = $this->event_type_model->create();	
