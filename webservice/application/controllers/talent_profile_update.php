...
class talent_profile_update extends REST_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model('talent_profile_update_model');
	...
	public function index_post()
	{
		$validationandresult = new validationandresult();
			if(isset($_POST) != "")
			{
					...
					// Empty key checking.
					$pre_key = array('talent_id','first_name','last_name','address','city','zipcode','country','company','special_skills','experience',
					'gender','hair_color','eye_color','height','languages','latitude','longitude','profile_url','pic1','pic2');
					...
					else
					{
						...
						{ 
							...
							$result = $this->talent_profile_update_model->index();	
