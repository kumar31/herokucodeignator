...
class get_confirmed_list_talent extends REST_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model('get_confirmed_list_talent_model');
			...
			if(isset($_POST) != "")
			{
					...
					else
					{
						...
						{ 
							...
							$result = $this->get_confirmed_list_talent_model->index();	
