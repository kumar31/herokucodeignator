...
class talent_checkout extends REST_Controller {
	...
	public function index_post()
	{
		$validationandresult = new validationandresult();
			if(isset($_POST) != "")
			{
					...
					// Empty key checking.
					$pre_key = array('event_id','client_id','talent_id','number_of_days','number_of_hours','number_of_minutes','talent_rating','agent_id');
					...
					else
					{
						...
						{ 
							...
							$result = $this->talent_checkout_model->index();	
