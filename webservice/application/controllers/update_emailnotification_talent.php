...
class update_emailnotification_talent extends REST_Controller {
	...
	public function index_post()
	{
		$validationandresult = new validationandresult();
			if(isset($_POST) != "")
			{
					...
					// Empty key checking.
					$pre_key = array('talent_id','email','email_notification','email_frequency');
					...
					else
					{
						...
						{ 
							...
							$result = $this->update_emailnotification_talent_model->index();	
