...
class talent_update_timesheet_recheck extends REST_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model('talent_update_timesheet_recheck_model');
	...
	public function index_post()
	{
		$validationandresult = new validationandresult();
			if(isset($_POST) != "")
			{
					...
					// Empty key checking.
					$pre_key = array('event_id','talent_id','number_of_days','number_of_hours','number_of_minutes');
					...
					else
					{
						...
						{ 
							...
							$result = $this->talent_update_timesheet_recheck_model->index();	
