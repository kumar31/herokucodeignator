...
class review_event extends REST_Controller {
	...
	public function index_post()
	{
		$validationandresult = new validationandresult();
			if(isset($_POST) != "")
			{
					...
					// Empty key checking.
					$pre_key = array('event_id','talent_id','review_star','review_comments');
					...
					else
					{
						...
						{ 
							...
							$result = $this->review_event_model->index();	
