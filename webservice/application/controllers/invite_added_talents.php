...
class invite_added_talents extends REST_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model('invite_added_talents_model');
	...
	public function index_post()
	{
		$validationandresult = new validationandresult();
			if(isset($_POST) != "")
			{
					...
					// Empty key checking.
					$pre_key = array('event_id','client_id');
					...
					else
					{
						...
						{ 
							...
							$result = $this->invite_added_talents_model->index();	
