...
class agent_update extends REST_Controller {
	...
	public function index_post()
	{
		$validationandresult = new validationandresult();
			if(isset($_POST) != "")
			{
					...
					// Empty key checking.
					$pre_key = array('admin_id','agent_id','name','email','password','percentage','address','outfit_fee');
					...
					else
					{
						...
						{ 
							...
							$result = $this->get_agent_details_model->update();	
