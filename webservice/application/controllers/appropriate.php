...
class appropriate extends REST_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model('appropriate_model');
	...
	public function index_post()
	{
		$validationandresult = new validationandresult();
			if(isset($_POST) != "")
			{
					...
					// Empty key checking.
					$pre_key = array('talentcount','talenttype','start_datetime','end_datetime');
					...
					else
					{
						...
						$this->form_validation->set_rules('talentcount', 'talentcount', 'trim|required');
						$this->form_validation->set_rules('talenttype', 'talenttype', 'trim|required');
						...
						{ 
							...
							$result = $this->appropriate_model->index();	
