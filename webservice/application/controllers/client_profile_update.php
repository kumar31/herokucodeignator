...
class client_profile_update extends REST_Controller {
	...
	public function index_post()
	{
		$validationandresult = new validationandresult();
			if(isset($_POST) != "")
			{
					...
					// Empty key checking.
					$pre_key = array('client_id','first_name','last_name','phone_number','company','address','postal_code','latitude','longitude','profile_url');
					...
					else
					{
						...
						{ 
							...
							$result = $this->client_profile_update_model->index();	
