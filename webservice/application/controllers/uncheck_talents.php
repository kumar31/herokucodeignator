...
class uncheck_talents extends REST_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model('uncheck_talents_model');
	...
	public function index_post()
	{
		$validationandresult = new validationandresult();
			if(isset($_POST) != "")
			{
					...
					// Empty key checking.
					$pre_key = array('client_id','talent_id');
					...
					else
					{
						...
						{ 
							...
							$result = $this->uncheck_talents_model->index();	
