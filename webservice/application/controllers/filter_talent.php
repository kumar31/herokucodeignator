...
class filter_talent extends REST_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model('filter_talent_model');
	...
	public function index_post()
	{
		$validationandresult = new validationandresult();
			if(isset($_POST) != "")
			{
					...
					// Empty key checking.
					$pre_key = array('client_id','special_skills','gender','hair_color','eye_color','height_min','height_max','languages');
					...
					else
					{
						...
						{ 
							...
							$result = $this->filter_talent_model->index();	
