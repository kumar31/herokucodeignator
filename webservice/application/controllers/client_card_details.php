...
class client_card_details extends REST_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model('client_card_details_model');
	...
	public function index_post()
	{
		$validationandresult = new validationandresult();
			if(isset($_POST) != "")
			{
					...
					// Empty key checking.
					$pre_key = array('client_id','name','number','cvv','expiration_month','expiration_year');
					...
					else
					{
						...
						{ 
							...
							$result = $this->client_card_details_model->index();	
