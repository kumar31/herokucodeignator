...
?>
 ...
 <div class="prepend-top form-group">
    <label class="pull-left required" for="">Set your preferred payment method</label>
                          <select class=
...
<div class="invitebutton">
                                    ...
                                    <a class="btn btn-submit btn-lg largeHeight" href="" role="button">Save Settings</a>
                                    </p>
                                </div>
   </div>
