...
$(document).ready(function() {
	...
	$('#results').load("<?php echo base_url();?>index.php/invite_talent_search/getblogdata/<?php echo $event_id; ?>", {'group_no':track_load,'search':search,'special_skills':special,'hair_color':haircolor,'eye_color':eyecolor,'languages':language,'height_min':heightfrom,'height_max':heightto,'best_rating':sort,'gender':gender,'eventid':eventid}, function() {track_load++;}); //load first group
	...
	$(window).scroll(function() { //detect page scroll
		...
		if($(window).scrollTop() + $(window).height() == $(document).height())  //user scrolled to bottom of the page?
		{
			...
			if(track_load <= total_groups && loading==false) //there's more data to load
			{
				...
				$.post('<?php echo base_url();?>index.php/invite_talent_search/getblogdata/<?php echo $event_id; ?>',{'group_no': track_load,'search':search,'special_skills':special,'hair_color':haircolor,'eye_color':eyecolor,'languages':language,'height_min':heightfrom,'height_max':heightto,'best_rating':sort,'gender':gender,'eventid':eventid}, function(data){
