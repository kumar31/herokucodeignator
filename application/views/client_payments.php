          ...
          <table class="table topmargin">
			...
			{ ?>
				<tbody>
				  <tr>
					<td>
					  <a target="_blank" href="http://smaatapps.com/nectorv2/html2pdf_v4.03/examples/adv.php?event_id=<?php echo $val['client_payment_details_id']; ?>"><?php echo $val['transaction_id']; ?>
					  </a>					  
					</td>
