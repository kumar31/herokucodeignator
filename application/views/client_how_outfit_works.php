      ...
      <div class="container centerText">
        <div class="row">
          ...
          <div class="col-xs-12 col-sm-8">
            ...
            <p style="color: white;">Outfit is an online connection service which aides event producers in securing bartenders, waiters and other front of house staff for their events. Outfit provides a place for clients to hand-pick the ‘talent’ for their events, manage their schedule, handle payments and invoicing with ease. The efficiency of Outfit means more money in the hand of talent and a reduced cost to clients.
            </p>
          </div>
          <div class="col-sm-2">
          </div>
