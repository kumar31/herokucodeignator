          ...
          <table class="table topmargin">
			...
			{ ?>
				<tbody>
				  <tr>
					<td>
					  <a target="_blank" href="<?php getenv( 'SOIREE_BASE_URL' ) ?>/html2pdf_v4.03/examples/adv2.php?event_id=<?php echo $val['talent_payment_details_id']; ?>"><?php echo $val['transaction_id']; ?>
					  </a>					  
					</td>
              ...
              <tbody>
                ...
                <tr>
				  ...
				  <?php
					...
					?>
                  <td class="bold">$<?php echo round($overall_pay,2); ?>
                  </td>
                </tr>
              </tbody>
            </table>
