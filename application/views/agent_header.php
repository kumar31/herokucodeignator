...
<head>
	...
	<?php if($url == 'agent_profile') { ?>
			<title>OUTFIT - Profile and payment settings</title>
		<?php
	} ?>
	
	<?php if($url == 'agent_talents') { ?>
			<title>OUTFIT - Talents</title>
		<?php
	} ?>
        ...
        <div class="container nav-menu-style" style="width:100%; padding-bottom: 10px;">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li class="pull-right">
                        <a href="<?php echo site_url();?>/agent_logout" class="gray-nav">LOGOUT</a>
                    </li>
