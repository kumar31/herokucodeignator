...
/*
$host = "localhost";
$dbuser ="smaatapp_myshul";
$db_password ="Myshul@1";
$database="smaatapp_myshul"; */
	...
	<table style="width: 100%;border: solid 1px #5544DD; border-collapse: collapse; font-size: 16px;" align="">
        ...
        <tbody>
			...
			<tr style="font-weight: bold;">
                ...
                <td style="width: 20%; text-align: center; border: solid 1px #000">
				 ...
				 if($tax=="0"){ $tax=$topays; } else { $tax=$withoutopay; } ?>   
                </td>
				<td style="width: 20%; text-align: center; border: solid 1px #000">
        ...
        <tfoot>
            <tr style="background-color: #ebdfc9;">
				...
				$total=  $BuyAmounts+$tax;  ?><?php echo $mycurrency;  ?>  <?php    $toAmount= get_currency('USD', $mycurrency, $total);	echo number_format((float)$toAmount, 2, '.', ''); ?>
			</th>
            </tr>
        </tfoot>
    </table>
