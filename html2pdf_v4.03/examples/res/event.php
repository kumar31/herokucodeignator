...
<page backimg="./res/Myshul-Logo-trans.png" backimgx="center"  backimgy="top"  backimgw="100%"  backtop="0" style="font-size: 14px;">
 ...
 //$getquery=mysql_query("SELECT * FROM `countries` WHERE iso_alpha2='$country'");
	...
	// }		 
	 ...
	 $quss=mysql_query("SELECT * FROM ProcessingFee WHERE Type='Event'");
...
$query=mysql_query("SELECT * FROM `Events` WHERE EventID=$EventID");
		
		$events = mysql_fetch_array($query);
			
		
		$UserID=$events['ShulID'];
...
// Call the function to get the currency converted
 ...
 ?>
	...
	<table style="width: 50%; font-size: 16px;"  cellspacing="0">
		<tr>
			<td style="width: 100%">Invoice Id : <b>INVOICE <?php echo $EventID; ?></b>  </td>
...
$mem=mysql_query("SELECT * FROM `EventMembers` WHERE `EventID` ='$EventID' AND `Unique`='$Unique'");
